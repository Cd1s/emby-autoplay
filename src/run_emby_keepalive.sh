...
export EMBY_URL EMBY_USERNAME EMBY_PASSWORD EMBY_PLAY_SECONDS EMBY_DEVICE_ID EMBY_CLIENT_NAME EMBY_CLIENT_VERSION EMBY_VERIFY_SSL EMBY_TIMEOUT EMBY_RETRY_ATTEMPTS EMBY_RETRY_BACKOFF_SECONDS
